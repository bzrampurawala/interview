 <!DOCTYPE html>
  ...
  <input class="sticky" type="button" value="30:00 remaining" id="timer">
  ...
  <form action="http://localhost/interview/send.php" method="post">
   ...
   <pre style="text-align: center;"><input type="submit" value="SUBMIT" onClick="quizStop()" style="font-size: 18px;"></pre>
